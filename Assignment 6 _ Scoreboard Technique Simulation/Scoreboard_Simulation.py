...
# 	Module : Scoreboard Simulator for assembly code from the SCB.asm file
# 		-- Eshita Arza		(COE15B013)
# 		-- Akshay Kumar		(CED15I031)
# 		-- Aditya Prakash	(CED15I025)

import sys
from Functional_Units import FunctionalUnit, FORMAT_HEADER
from Decode import instructions as inst_funcs

if len(sys.argv) != 2:
	print('Invalid command!!!\n')
	print('Command Format :\n\tpython3 <script_name.py> <assembly_file_name>')
	sys.exit()
